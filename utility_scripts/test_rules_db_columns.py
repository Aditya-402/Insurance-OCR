...
def get_rules_db_columns():
    """
    Connects to the Rules database and prints the column names of the procedure_rules table.
    """
    conn = None
    try:
        ...
        table_name = 'procedure_rules' # Use lowercase for the query
